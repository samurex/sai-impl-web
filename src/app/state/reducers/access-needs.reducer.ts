 ...
 */
export type AccessNeedsState = EntityState<AccessNeed>
...
export type AccessNeedGroupState = EntityState<AccessNeedGroup>
...
export type ShapetreesState = EntityState<ShapeTree>
